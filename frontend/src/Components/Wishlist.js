...
import img5 from "../Images/Arrow_back.png";
...
function Wishlist() {
  ...
  const endIndex = Math.min(
    startIndex + rowsPerPage * productsPerRow,
    totalProducts
  );
    ...
    <>
      ...
      <div className="sub-title">
        ...
        <p className="result-text">
          Showing {startIndex + 1} - {endIndex} out of {totalProducts} Results
        </p>
                  ...
                  <div key={index} className="product-item">
                    ...
                    <div className="product-details">
                      <p className="model-type">
                        Pink Overload Over - Sized T-shirt
                      </p>
        ...
        <div className="browse_other">
          <Link to="/" className="browse-other-link">
            <img src={img5} alt="" />
          </Link>
          <span className="browse-other-btn">Browse other products</span>
        </div>
